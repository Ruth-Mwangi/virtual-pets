...
public class DatabaseRule extends ExternalResource {
    ...
    protected void before() {
        DB.sql2o = new Sql2o("jdbc:postgresql://localhost:5432/virtual_pets_test", "wangui", "33234159");  //Those with
        // linux or windows use two strings for username and password
    }
