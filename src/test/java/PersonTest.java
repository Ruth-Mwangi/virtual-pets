...
public class PersonTest {
    ...
    public void person_instantiatesCorrectly_true(){
        Person testPerson=new Person("Ruth","rwmwangi96@gmail.com");
        assertEquals(true,testPerson instanceof Person);
    }
    @Test
    public void getName_personInstantiatesWithName_Henry() {
        Person testPerson = new Person("Ruth", "rwmwangi96@gmail.com");
        assertEquals("Ruth", testPerson.getName());
    }

    @Test
    public void getEmail_personInstantiatesWithEmail_String() {
        Person testPerson = new Person("Ruth", "rwmwangi96@gmail.com");
        assertEquals("rwmwangi96@gmail.com", testPerson.getEmail());
    }

    @Test
    public void equals_returnsTrueIfNameAndEmailAreSame_true() {
        Person firstPerson = new Person("Ruth", "rwmwangi96@gmail.com");;
        Person anotherPerson = new Person("Ruth", "rwmwangi96@gmail.com");;
